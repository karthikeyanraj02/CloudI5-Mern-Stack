...
export default function Footer() {
  return (
    <>
      <div className=" border border-[#012216] max-h-fit bg-[#012216] mx-3 md:mx-5 lg:mx-7 xl:mx-9">
        <div className=" mx-6 md:mx-10 lg:mx-14 xl:mx-16 mt-6 md:mt-10 lg:mt-14 xl:mt-16">
          <div className="grid grid-cols-2 gap-x-8 gap-y-8 md:grid-cols-3 lg:grid-cols-5">
            <div className=" ">
              <div className="text-white text-start font-f1  text-sm md:text-base lg:text-base xl:text-lg font-bold">
                SERVICES
              </div>
              <ul className="text-white font-f1  text-start text-xs md:text-xs lg:text-sm xl:text-base mt-4 md:mt-4.5 lg:mt-5 xl:mt-5.5">
            ...
            <div className=" ">
              ...
              <ul className="text-white text-start font-f1  text-xs md:text-xs lg:text-sm xl:text-base mt-4 md:mt-4.5 lg:mt-5 xl:mt-5.5">
                <li className="  mt-1 md:mt-1.5 lg:mt-2">
          ...
          <div className=" md:flex justify-between w-full">
            <div className="mt-1">
              ...
              />
              <div className="text-white text-justify font-f1  text-xs mt-2 md:mt-3.5 lg:mt-5 xl:mt-4 md:w-64 lg:w-96 xl:w-1/2  ">
            ...
            <div>
              <div className="mt-8 md:mt-4 lg:mt-4">
                <div className="text-white font-f1  text-start text-base md:text-lg lg:text-lg xl:text-lg font-bold">
                  Social Media
                </div>
                <div className="text-white font-f1  text-xs mt-2 md:mt-2.5 lg:mt-3 xl:mt-3.5  w-52 ">
      ...
      <div className="bg-[#06885B] font-f1  mx-3 md:mx-5 lg:mx-7 xl:mx-9  text-center text-white p-3 md:p-4 lg:p-5 xl:p-6 text-[0.63rem] md:text-xs    ">
